...
<body class="dashboard-body">
  ...
  <aside class="sidebar">
    <div class="mb-8 flex items-center gap-3">
        <div style="width:40px; height:40px; border-radius:50%; overflow:hidden; background:#eff6ff; display:flex; align-items:center; justify-content:center;">
            <?php if(!empty($user['foto_profil'])): ?>
                <img src="assets/uploads/profil/<?= htmlspecialchars($user['foto_profil']) ?>" class="w-full h-full object-cover">
            <?php else: ?>
                <span class="font-bold text-blue-600"><?= substr($user['nama'],0,1) ?></span>
            <?php endif; ?>
        </div>
        <div>
