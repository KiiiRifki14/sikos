...
// =========================
// PENGHUNI: UX enhancements appended to main.js (scoped via body.role-penghuni)
// These additions are appended at the end to avoid touching existing logic.
// =========================
// assets/js/main.js
// Single consolidated DOMContentLoaded handler
document.addEventListener('DOMContentLoaded', function() {
    ...
    // --- make a global toggle function available for pages that call onclick="toggleSidebar()" ---
    window.toggleSidebar = function(){
        const isCollapsed = document.body.classList.toggle('sidebar-collapsed');
        localStorage.setItem('sidebarState', isCollapsed ? 'collapsed' : 'expanded');
        document.querySelectorAll('.sidebar-toggle').forEach(btn => btn.setAttribute('aria-expanded', isCollapsed ? 'true' : 'false'));
    };
