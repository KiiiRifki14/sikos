<?php
// [OOP: Core Loading] Import file inti
require '../inc/koneksi.php';
require '../inc/guard.php';

// [Security Checker] Hanya Admin yang boleh akses
if (!is_admin()) {
    header('Location: ../login.php');
    exit;
}

// [OOP: Object] Init DB untuk ambil data pendukung (tipe kamar)
$db = new Database();
...
<head>
    ...
    <!-- [CSS Embedded] Style custom khusus halaman ini (Single Use CSS) -->
    <style>
        .form-container {
            max-width: 850px;
            margin: 0 auto;
        ...
        /* CSS Grid Layout untuk form 2 kolom */
        .form-grid {
            display: grid;
...
<body class="dashboard-body">
            ...
            <form method="post" action="kamar_proses.php?act=tambah" enctype="multipart/form-data">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <select name="id_tipe" class="form-input" required>
                            ...
                            <!-- [Logic] Render Data Tipe Kamar dari Database -->
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <!-- [HTML5] Attribute multiple mengizinkan select banyak file -->
                ...
                <div class="form-group" style="margin-top: 10px; border-top: 1px solid #f1f5f9; padding-top: 15px;">
                    ...
                    <div class="fasilitas-grid">
                        <?php
                        // [Direct Query] Mengambil master data fasilitas untuk pilihan checklist
                        $q_fas = $mysqli->query("SELECT * FROM fasilitas_master ORDER BY nama_fasilitas ASC");
                        while ($f = $q_fas->fetch_assoc()):
                        ?>
                            <label class="check-item">
                                <!-- Array fasilitas[] nanti akan di-loop di PHP Processing -->
    ...
    <script>
        // [Client Side Script] Fungsi untuk menampilkan preview gambar saat user memilih file
