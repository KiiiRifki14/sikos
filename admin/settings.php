            ...
            <form method="post">
                <div class="form-grid">
                    ...
                    <div>
                        ...
                        <input type="text" name="pemilik" class="form-input" value="<?= $data['pemilik'] ?>" maxlength="30" oninput="validateName(this)" required>
                    </div>
                </div>
                ...
                <div class="form-grid">
                    <div>
                        ...
                        <input type="tel" name="no_hp" class="form-input" value="<?= $data['no_hp'] ?>" maxlength="17" oninput="validatePhone(this)" required>
                    </div>
                    <div>
