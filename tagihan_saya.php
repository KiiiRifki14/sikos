                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align:center;">
                                            <?php if ($row['status'] == 'BELUM' && $statusBayar != 'PENDING'): ?>
                                                <?php if ($statusBayar == 'DITOLAK'): ?>
                                                    <a href="pembayaran_tagihan.php?id=<?= $row['id_tagihan'] ?>" class="btn" style="background:#ef4444; color:white; padding: 8px 16px; font-size: 12px; border-radius:8px;">
                                                        <i class="fa-solid fa-rotate-right mr-1"></i> Bayar Ulang
                                                    </a>
                                                <?php else: ?>
